        ...
        with tools.chdir("source"):
            if os_info.is_windows:
                tools.replace_in_file(
                    "Tools/XMLConverter/CMakeLists.txt", "pugixml", "CONAN_PKG::pugixml"
                )
                tools.replace_in_file(
                    "PlugIns/DotScene/CMakeLists.txt", "pugixml", "CONAN_PKG::pugixml"
                )
                tools.replace_in_file(
                ...
                tools.replace_in_file(
                    "Components/Overlay/CMakeLists.txt", "${FREETYPE_INCLUDE_DIRS}", ""
                )
                tools.replace_in_file("CMakeLists.txt", "FreeImage_FOUND", "TRUE")
                tools.replace_in_file(
                    "PlugIns/FreeImageCodec/CMakeLists.txt",
